...
const PopularProducts = () => {
  ...
  return (
    <div className="container py-section">
      ...
      <div className="grid lg:grid-cols-4 gap-y-5 mt-6">
        {popularProducts.map((item, index) => {
          return (
            <div
              key={index}
              className={`w-full h-full max-w-[330px] relative border-r ${
                index === 3 || index === 8 || index === 13 ? "border-none" : ""
              }`}
            >
                ...
                <div className="absolute bottom-0 left-6 right-6 ">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center">
                      ...
                      <h6 className="h6 text-red-500 ml-1">21 in stock</h6>
                    </div>
