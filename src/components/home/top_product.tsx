              ...
              <div className="flex flex-col justify-between p-6">
                <div className="py-8">
                  <div className="flex items-center justify-between">
                    <p className="h6 bg-[#FFFBF5] px-2 py-1 rounded-full">
                      In Stock
                    </p>
...
{
  /* <div className="h-full w-[264px] border" key={index}>
<div>
  <div className="flex justify-center items-center py-4 px-[38px]">
    {" "}
    <Image
      src={item.image}
      alt=""
  ...
  <div className="px-6 pt-6 pb-6 flex flex-col justify-between">
    <div>
      <div className="flex items-center justify-between">
        <p className="h6">In Stock</p>
        <h5 className="h6">4.9</h5>
      </div>
      <h3 className="h5 pb-2 pt-[14px]">{item.name}</h3>
      <div className="flex items-center gap-x-4">
        <h5 className="price">499 Tk</h5>
        <h5 className="price font-normal text-base text-gray-400">
          599 Tk
        </h5>
      </div>
    </div>
    <div className="flex justify-between">
      <h6 className="quantity">250 ml</h6>
      <div className="flex items-center border rounded-full w-fit px-3 py-[2px] gap-x-2">
        <Image src="/plus.png" alt="" height={16} width={16} />
        <p className="h6 text-[#E38407]">Add</p>
      </div>
    </div>
